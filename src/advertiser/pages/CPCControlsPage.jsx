...
export default function CPCControlsPage() {
  ...
  return (
    <div style={{ fontFamily: "'Open Sans', sans-serif", display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--osmos-bg)' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, fontFamily: "'Open Sans', sans-serif" }}>
          ...
          <tbody>
            {filteredRows.map((row, i) => {
              ...
              const cpcColor = (val) => val && val.startsWith('$') ? 'var(--osmos-brand-primary)' : 'var(--osmos-fg-muted)';
              return (
                <tr
                  key={i}
      ...
      <div style={{
        ...
        <button
          onClick={() => showToast('CPC settings saved successfully')}
          style={{
